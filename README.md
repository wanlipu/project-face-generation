...
This is part of Udacity Deep Learning Program, and this repository is meant to document my progress towards face generation project completion.

In this project, I trained a generative adversarial network (GAN) to generate fake celebrity faces. 

## Steps
- Data Pre-processing
- Build the GAN (Discriminator and Generator Networks)
- Train GAN model
